<template>
    <div class="city_body">
        <div class="city_list">
            ...
            <ScrollView v-else ref="city_List">
                <div>
                    <div class="city_hot">
                        <h2>热门城市</h2>
                        <ul class="clearfix">
   ...
   export default {
            ...
            if(cityList && hotList){
                ...
                this.axios.get('/api/cityList').then((res)=>{
                    ...
                    if(msg === 'ok'){
                            ...
                            this.isLoading = false
                            var { cityList,hotList } = this.foematCityList(cities);
      ...
      methods:{
            foematCityList(cities){
                ...
                //按字符循序排列城市
                for(var i = 0;i<cities.length;i++){
                    var firstLetter = cities[i].py.substring(0,1).toUpperCase(); //剪切首位字母并转换大写
            ...
            handleIndex(index){
                ...
                this.$refs.city_List.handleIndexTop(-h2[index].offsetTop);
            },
            handleToCity(nm,id){
